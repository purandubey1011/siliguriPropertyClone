...
const UserProfile = () => {
  ...
  const dummyCoverImage = "https://images.unsplash.com/photo-1449844908441-8829872d2607?q=80&w=2000&auto=format&fit=crop";

  const displayProfileImage = formData.profileImage || dummyProfileImage;
          ...
          <div className="w-full md:w-1/3 space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
              <div className="pt-8 pb-6 px-6 flex flex-col items-center text-center">
                ...
                <p className="text-pink-400 font-medium mb-4">{formData.role}</p>
          ...
          <div className="w-full md:w-2/3">
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8">
              <div className="flex justify-between items-center mb-6 border-b pb-4">
                ...
                {isEditing && <span className="text-xs text-amber-600 bg-amber-50 px-2 py-1 rounded border border-amber-200">Editing Mode Enabled</span>}
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1 flex items-center">
                      <Phone className="w-3 h-3 mr-1 text-gray-400" /> Phone Number
                    </label>
                    <input 
                      type="tel" 
                      name="phoneNumber"
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1 flex items-center">
                      <MessageCircle className="w-3 h-3 mr-1 text-gray-400" /> WhatsApp Number
                    </label>
                    <input 
                      type="tel" 
                      name="whatsappNumber"
